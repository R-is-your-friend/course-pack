...
<!-- checkin about how many of each function (if, else if, else) you would have for a given number of options -->
...
only works if you have **two** groups or **one** condition you need to check. 
In many cases we have more than one condition to check, so we will need to
modify our conditional statement.

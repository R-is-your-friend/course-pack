...
Suppose we wanted to create a control flow to know how much in federal taxes someone in the US might pay. Based on the [current IRS tax rates](https://www.irs.gov/filing/federal-income-tax-rates-and-brackets) we have the following outcomes[^03-control-flow-1]:

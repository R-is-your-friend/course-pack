...
Note sections contain clarification points (anywhere we would normally say "note that ....).  Make sure to read them to avoid any common pitfalls or misconceptions.
:::
...
Consider these to be optional readings/viewings. The world of programming has so many interesting tidbits, we can't possibly teach them all - but we want to share them with you nonetheless!

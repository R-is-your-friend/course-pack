...
<!--CHECK FOR OVERLAP IN THIS SECTION-->
...
Just looking at a data frame in R, we can't tell how the variables are measured and what they all mean! We will always want to look at a **data dictionary** to understand what the columns really mean. Any good data provider should provide a data dictionary along with the data!

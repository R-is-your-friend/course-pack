...
In this class, we will primarily focus on working with what we call *rectangular data* meaning that the data is two-dimensional with rows and columns. With rectangular data, each *row* represents one observation (or observational unit) and each *column* represents a data *variable*. Note that this is distinct from an *environmental variable* in R! Throughout this course, while talking about rectangular data, we may use "column" and "variable" interchangeably to discuss data variables.

...
<!-- perhaps link back to the case-when content in ch 03a? -->
...
3. How do you provide a value for the "rest" of the rows that do not meet the criteria you already included in `case_when()`?
...
2. What does `across()` do by default to column names?

3. What arguments to `across()` help you control the resulting column names?
:::
